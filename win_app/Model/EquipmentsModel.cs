...
namespace SOM.Model
{
    public class EquipmentsModel
    {
        ...
        public EquipmentsModel(string ID, string Name, string State, string Interlock_ID, string Creator, Nullable<DateTime> Created_at, string Modifier = null, Nullable<DateTime> Updated_at = null) 
        {
